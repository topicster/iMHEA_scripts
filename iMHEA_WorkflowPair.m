...
%iMHEA workflow for paired catchments.
% [DataHRes,Data1day,Data1hr,Indices,Climate,PM,QM,FDC1,FDC2,IDC1,IDC2] =
% iMHEA_WorkflowPair(DataHRes1,DataHRes2) assimilates the processed
% precipitation and discharge data to provide a pairwise assessment.
%
% Input:
